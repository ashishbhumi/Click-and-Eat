      ...
      >
        {({
          ...
          <div className="login-container ">
            <div className="login-form flex m-4 p-4w-6/12  ">
              {/* Passing handleSubmit parameter to html form onSubmit property */}
              <form noValidate onSubmit={handleSubmit} className="m-4 p-4 w-6/12">
                ...
                <input
                  ...
                  className="form-control inp_text border border-black p-2 m-2"
                  id="email"
                />
                ...
                <input
                  ...
                  className="form-control border border-black p-2 m-2"
                />
                {/* If validation is not passed show errors */}
                <p className="error">
                ...
                <button type="submit" className=" border border-black p-2 m-2 bg-gray-100 rounded-lg">Login</button>
              </form>
            </div>
          </div>
        )}
